    ...
    <div class="col-xs-12 text-center">
      <ul class="pager">
        <gt name="forum_page" value="1">
          <li><a href="{:ff_url('forum/guestbook', array('p'=>($forum_page-1)), true)}">Previous page</a></li>
        </gt>
        <lt name="forum_page" value="$page_array['totalpages']">
          <li><a href="{:ff_url('forum/guestbook', array('p'=>($forum_page+1)), true)}">Next page</a></li>
        </lt>
      </ul> 
    </div>
  </div>
