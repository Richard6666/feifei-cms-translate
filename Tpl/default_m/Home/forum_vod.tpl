...
<title>{$vod['vod_name']}Film Critics{$forum_page}页_{$site_name}</title>
<meta name="keywords" content="{$vod['vod_name']}Film critic,{$vod['vod_name']}A sense of view">
<meta name="description" content="{$vod['vod_name']}A total of film critics{$page_array.totalpages}页,For you to show the first{$forum_page}Of the wonderful comments.">
</head>
