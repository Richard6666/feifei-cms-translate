<php>
$block_actor_name = 'With the starring works';
...
<ul class="row list-unstyled ff-play-item">
  ...
  <li class="col-xs-8">
    ...
    <p class="ff-text-hidden ff-link">Starring{$feifei.vod_actor|ff_url_search}</p>
    <p>Types of:<a href="{:ff_url_vod_show($list_id,$list_dir,1)}">{$feifei.list_name}</a></p>
    <p>score:{$feifei.vod_gold|ff_gold}</p>
  </li>
