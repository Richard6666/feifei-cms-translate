...
<title>{$user_name|htmlspecialchars}Published message _{$site_name}</title>
...
<div class="col-xs-10 col-xs-offset-1">
  <div class="page-header">
    <h4>
    	...
    	<a href="{:ff_url('forum/detail', array('id'=>$forum_id), true)}">Message subject</a>
    </h4>
  </div>
</div>
<div class="clear"></div>
...
<div class="col-xs-10 col-xs-offset-1">
  <div class="page-header">
    <h4><span class="glyphicon glyphicon-heart-empty ff-text"></span> leave a feedback</h4>
  </div>
</div>
<div class="clear"></div>
