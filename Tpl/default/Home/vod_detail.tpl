...
<title><in name="list_id" value="2,3,4">《{$vod_name}"Complete Works Online Watch -{$list_name}<else />《{$vod_name}"HD online watch-the film{$vod_name}download</in>－{$site_name}</title>
...
<div class="row">
    ...
    <ul class="list-unstyled vod-infos">
      ...
      <li class="col-xs-8">
          ...
          <dt class="hidden-xs">Plot:</dt>
          <dd class="hidden-xs vod-content">{$vod_content|h|msubstr=0,99}<a href="#vod_content" class="btn btn-link ff-text">detailed...</a></dd>
        </dl>
      </li>
    </ul>
  ...
  <div class="col-md-4 ff-col visible-lg visible-md">
  	<div class="page-header">
      <h4><span class="glyphicon glyphicon-signal ff-text"></span> Praise list</h4>
    </div>
    <ol class="ff-vod-hot">
