...
<div class="container ff-bg vod-type">
  <div class="row">
      ...
      <div class="page-header">
        ...
        <small>{$type_type} {$type_area} {$type_year} {$type_star} {$type_state} Altogether<label class="ff-text">{:ff_page_count('type', 'records')}</label>A movie  First<span class="ff-text">{$type_page}</span>page</small>
        </h4>
      </div>
    </div>
