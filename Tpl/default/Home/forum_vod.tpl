...
<title>{$vod['vod_name']}Film Critics{$forum_page}page_{$site_name}</title>
<meta name="keywords" content="{$vod['vod_name']}Film critic,{$vod['vod_name']}A sense of view">
<meta name="description" content="{$vod['vod_name']}A total of film critics{$page_array.totalpages}page,For you to show the first{$forum_page}Of the wonderful comments.">
</head>
...
<div class="col-xs-10 col-xs-offset-1">
  <div class="page-header">
    <h4><span class="glyphicon glyphicon-heart-empty ff-text"></span> <a href="{$page_this}">{$vod['vod_name']}Wonderful critics</a></h4>
  </div>
</div>
<div class="clear"></div>
...
<div class="col-md-10 col-md-offset-1 col-xs-12 vod-detail">
  <ul class="row list-unstyled vod-infos">
    <li class="col-md-4 col-xs-4">
      <img class="img-responsive img-thumbnail ff-img vod-pic" data-original="{$vod.vod_pic|ff_url_img}" alt="{$vod.vod_name}Complete watch">
    </li>
    <li class="col-md-8 col-xs-8">
      <dl class="dl-horizontal">
        ...
        <dd class="hidden-xs"><a href="{:ff_url('vod/type',array('id'=>$list_id,'type'=>'','area'=>urlencode($vod_area),'year'=>'','star'=>'','state'=>'','order'=>'hits'),true)}">{$vod.vod_area|default='Not entered'}</a></dd>
        <dt>年份：</dt>
        ...
        <dt>Plot:</dt>
        <dd class="vod-content">{$vod.vod_content|strip_tags|msubstr=0,200,'utf-8',true}<a class="ff-text" href="{:ff_url_vod_read($vod['list_id'],$vod['list_dir'],$vod['vod_id'],$vod['vod_ename'],$vod['vod_jumpurl'])}" target="_blank">Free to watch</a></dd>
      </dl>
    </li>
  </ul>
</div>
...
<div class="col-md-10 col-md-offset-1 col-xs-12">
  <form class="form-horizontal col-xs-12 ff-form form-forum" id="form-forum" role="form" action="{$root}index.php?s=forum-update" method="post">
    ...
    <div class="form-group ff-submit text-right">
      ...
      <label>
    		<button type="submit" class="btn btn-default btn-sm">Published a film critic</button>
      </label>
    </div>
...
<div class="col-md-10 col-md-offset-1 col-xs-12">
  <div class="row">
    ...
    <div class="col-md-11 col-xs-10">
      <p class="forum-title">
      	《<a href="{:ff_url('forum/vod', array('cid'=>$feifei['forum_cid']), true)}">{$feifei.vod_name}</a>"The film critic
      ...
      <p class="forum-btn">
        ...
        <a class="btn btn-default btn-xs" href="{:ff_url_vod_read($feifei['list_id'],$feifei['list_dir'],$feifei['vod_id'],$feifei['vod_ename'],$feifei['vod_jumpurl'])}" target="_blank"><span class="glyphicon glyphicon-play"></span> Free to watch</a>
      </p>
