...
<div class="row">
    ...
    <p class="text-center">
      <a class="btn btn-default btn-lg ff-updown" href="javascript:;" data-id="{$news_id}" data-module="news" data-type="up" data-toggle="tooltip" data-placement="top" title="it works">
