  	...
  	<div class="col-xs-7">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-3 ff-col-0">
          	<button type="submit" class="btn btn-default" data-module="vod" data-action="{:ff_url('vod/search',array('name'=>'FFWD'), true)}">Search video</button>
        		<button type="submit" class="btn btn-default btn-success" data-module="news" data-action="{:ff_url('news/search',array('name'=>'FFWD'), true)}">Search information</button>
          </div>
        </div>
      </form>
    </div><!-- /.col-xs-5 -->
  ...
  <div class="row">
    ...
    <div class="page-header">
      <h4>
        ...
        <small class="pull-right visible-xs"><a href="{:ff_url('vod/type',array('id'=>$feifeilist['list_id'],'type'=>'','area'=>'','year'=>'','star'=>'','state'=>'','order'=>'hits','p'=>1),true)}">More</a></small>
      </h4>
    </div>
    <!-- -->
